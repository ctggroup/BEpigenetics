...
process_posterior<- function(chains,probe_names,genexprobe,subsample){
  ...
  #VEepi<-do.call(rbind,chainsSigma)[,1]/rowSums(do.call(rbind,chainsSigma))
  #VEgene<-do.call(rbind,chainsSigma)[,2]/rowSums(do.call(rbind,chainsSigma))
  ...
  list(PIP=postIncl, #posterior inclusion probabilities
       ...
       VEepi=do.call(rbind,chainsSigma)[,"sigma[phi]^2"]/rowSums(do.call(rbind,chainsSigma)),#VE by probes
       VEgene=do.call(rbind,chainsSigma)[,"sigma[G]^2"]/rowSums(do.call(rbind,chainsSigma)) #VE SNP
  )
