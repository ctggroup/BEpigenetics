...
g3<-ggplot()+geom_bar(data=melt(data.frame(Trait=genesEwas$Trait)),mapping=aes(x=Trait)) +ggtitle("Previous probe associations from EWAS catalog BMI")
...
f <- ggplot(g4, aes(x=median, y=reorder(Parameter, median),color=Marker)) + geom_point(size=3) +
        ...
        xlab("HPD") + ylab("Parameter")+theme(axis.text=element_text(size=5),legend.position = "none")+ggtitle("Effects of markers with 95% IP BMI")+ylab("Marker")+scale_color_discrete(name = "Marker type")+theme_light()+theme(legend.position = "none")
...
theme_new <- theme_set(theme_light())
theme_new <- theme_update(axis.text.x = element_text(angle = 45, hjust = 1))
g3<-ggplot()+geom_bar(data=melt(data.frame(Trait=genesEwas$Trait)),mapping=aes(x=Trait)) +ggtitle("Previous probe associations from EWAS catalog smoking")
...
f <- ggplot(g4, aes(x=median, y=reorder(Parameter, median),color=Marker)) + geom_point(size=3) +
        geom_segment(aes(x=Low, xend=High, yend=reorder(Parameter, median),color=Marker), size=1.5) +
        geom_segment(aes(x=low, xend=high, yend=reorder(Parameter, median),color=Marker), size=0.5) +
        xlab("HPD") + ylab("Parameter")+theme(axis.text=element_text(size=5))+ggtitle("Effects of markers with 95% IP smoking")+ylab("Marker")+scale_color_discrete(name = "Marker type")+theme_light() 
